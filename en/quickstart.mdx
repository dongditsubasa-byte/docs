...
<Steps>
  ...
  <Step title="Make your first request">
    Request current weather by city or coordinates (example path; see API Explorer for the latest spec):
  ...
  <Step title="Explore products">
    Browse the sidebar groups for field definitions by use case.
  </Step>
</Steps>
